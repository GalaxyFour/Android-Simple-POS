...
public class PembayaranActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inisialisasi();
        long harga_total = getIntent().getLongExtra("harga_total", 0);
        long uang_pembeli = getIntent().getLongExtra("uang_pembeli", 0);
        long uang_kembalian = getIntent().getLongExtra("uang_kembalian", 0);
        long total_keuntungan = getIntent().getLongExtra("total_keuntungan", 0);
